...
```{r, microsimr_correct, fig.cap = "Distribution of estimates of $\theta$ for 1000 loci simulated using $\theta$ = 50 (marked by the vertical red line). We can see why the variance is big now, the shape of the distribution is typical of coalescent process, and reflects the distribution of tree heights.", eval = FALSE}
